This repo is a modern Telegram bot for CSUST built with Go 1.24+, featuring AI chat, message search (MeiliSearch), image generation (Stable Diffusion), gacha systems, and comprehensive permission controls.
