...
func testIntUintToA(t *testing.T) {
	...
	t.Run("int", func(t *testing.T) {
		...
		t.Run("to dec", func(t *testing.T) {
			...
			ass.Equal("0", I2Dec[int](0))
			ass.Equal("1", I2Dec[int](1))
			ass.Equal("-1", I2Dec[int](-1))
			ass.Equal("123", I2Dec[int](123))
		})
		...
		t.Run("to hex", func(t *testing.T) {
			...
			ass.Equal("0", I2Hex[int](0))
			ass.Equal("1", I2Hex[int](1))
			ass.Equal("-1", I2Hex[int](-1))
			ass.Equal("7b", I2Hex[int](123))
			ass.Equal("ffffffff", I2Hex[int](0xffffffff))
			ass.Equal("eeeeeeee", I2Hex[int](0xeeeeeeee))
			ass.Equal("7fffffffffffffff", I2Hex[int](0x7fffffffffffffff))
			ass.Equal("7eeeeeeeeeeeeeee", I2Hex[int](0x7eeeeeeeeeeeeeee))
			ass.Equal("-ffffffff", I2Hex[int](-0xffffffff))
			ass.Equal("-eeeeeeee", I2Hex[int](-0xeeeeeeee))
			ass.Equal("-7fffffffffffffff", I2Hex[int](-0x7fffffffffffffff))
			ass.Equal("-7eeeeeeeeeeeeeee", I2Hex[int](-0x7eeeeeeeeeeeeeee))
		...
		t.Run("to bin", func(t *testing.T) {
			...
			ass.Equal("0", I2Bin[int](0))
			ass.Equal("1", I2Bin[int](1))
			ass.Equal("-1", I2Bin[int](-1))
			ass.Equal("1111011", I2Bin[int](123))
			ass.Equal("11111111111111111111111111111111", I2Bin[int](0xffffffff))
			ass.Equal("11101110111011101110111011101110", I2Bin[int](0xeeeeeeee))
			ass.Equal("111111111111111111111111111111111111111111111111111111111111111", I2Bin[int](0x7fffffffffffffff))
			ass.Equal("111111011101110111011101110111011101110111011101110111011101110", I2Bin[int](0x7eeeeeeeeeeeeeee))
			ass.Equal("-11111111111111111111111111111111", I2Bin[int](-0xffffffff))
			ass.Equal("-11101110111011101110111011101110", I2Bin[int](-0xeeeeeeee))
			ass.Equal("-111111111111111111111111111111111111111111111111111111111111111", I2Bin[int](-0x7fffffffffffffff))
			ass.Equal("-111111011101110111011101110111011101110111011101110111011101110", I2Bin[int](-0x7eeeeeeeeeeeeeee))
