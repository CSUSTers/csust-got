...
Cron lets an interactive agent schedule recurring, self-contained work. A dedicated
...
Five numeric fields: minute, hour, day-of-month, month, day-of-week. Supported:
`*`, lists, inclusive ranges, positive steps; Sunday is 0 or 7. No seconds/year,
macros, names, `?`, `L`, `W`, or `#`. Restricted day-of-month and day-of-week use OR;
...
replays. The next normal occurrence remains scheduled independently of manual retry.
